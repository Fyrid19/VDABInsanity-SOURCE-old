...
// The begining mouse location that all drag movements are in reference of
	...
	override function create()
	{
		...
		healthBarBG = new FlxSprite(30, FlxG.height - 75).loadGraphic(Paths.image('roundBarFilled'));
		healthBarBG.scrollFactor.set();
		add(healthBarBG);
		healthBarBG.cameras = [camHUD];

        healthBarBG2 = new FlxSprite(30, FlxG.height - 90).loadGraphic(Paths.image('roundBarFilled'));
